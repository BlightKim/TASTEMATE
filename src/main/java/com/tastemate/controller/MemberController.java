...
//        List<memberVO> memberVO = service.user_get();
  ...
  public String loginPost(Model model, HttpServletRequest request, HttpSession session,
      @RequestParam(name = "redirectURL", defaultValue = "/member/list") String redirectURL) {
  ...
  public String registerMember(Model model, @RequestParam(name = "food") String food,
  ...
  public String mbtiPost(Model model, @RequestParam(name = "userMbti") String userMbti,
      HttpServletRequest request) {
    HttpSession session = request.getSession(false);
  ...
  public String mbtiGet(Model model, @RequestParam(name = "userClass") Integer userClass,
      HttpServletRequest request) {
  ...
  public String classesPost(Model model, @RequestParam(name = "userClass") Integer userClass,
      HttpServletRequest request) {
    return "member/mbti";
  }

  @GetMapping("member/selectFood")
  public String food(Model model, @RequestParam(name = "mbti") String userMbti,
      HttpServletRequest request) {
    HttpSession session = request.getSession(false);
...
//    }
  ...
  @PostMapping("modify")
  public String userModify(MemberVO vo, MultipartFile oriProfile, HttpServletRequest request,
      HttpSession session) {
